    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#services"><span>Informasi</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="#">PPDB</a></li>
    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          ...
          <p data-aos="fade-up" data-aos-delay="100">Ketersediaan lingkungan yang nyaman dan guru yang berpengalaman akan mendorong kamu dari awal hingga akhir proses pembelajaran.<br></p>
