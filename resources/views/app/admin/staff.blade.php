                ...
                <tbody id="staffTable">
                    @forelse($staff as $index => $staffItem)
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-warning btn-sm" data-id="{{ $staffItem->id }}" data-toggle="modal" data-target="#editModal">Edit</button>
                                <button type="button" class="btn btn-danger btn-sm" data-id="{{ $staffItem->id }}" data-toggle="modal" data-target="#deleteModal">Delete</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.querySelectorAll('[data-target="#deleteModal"]').forEach(button => {
            button.addEventListener('click', function () {
                const staffId = this.getAttribute('data-id');
                document.querySelector('#deleteModal input[name="staff_id"]').value = staffId;
            });
        });
    });
