    ...
    <div class="card-body">
      ...
      <table class="table table-bordered table-striped">
        ...
        <td>
          ...
          data-target="#editDataModal-{{ $platform->id }}">Edit</button>

          <!-- Tombol Hapus -->
          <button class="btn btn-danger btn-sm" data-toggle="modal"
          data-target="#deleteConfirmationModal-{{ $platform->id }}">Delete</button>

        </td>
        </tr>

        <!-- Modal Edit Data untuk Setiap Platform -->
        <div class="modal fade" id="editDataModal-{{ $platform->id }}" tabindex="-1"
        aria-labelledby="editDataModalLabel-{{ $platform->id }}" aria-hidden="true">
        ...
        <div class="modal fade" id="deleteConfirmationModal-{{ $platform->id }}" tabindex="-1"
        aria-labelledby="deleteConfirmationModalLabel-{{ $platform->id }}" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
          <div class="modal-header">
